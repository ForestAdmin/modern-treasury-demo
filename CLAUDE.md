...
📘 [Docs → Custom Data Sources](https://docs.forestadmin.com/developer-guide-agents-nodejs/data-sources/custom)
...
Use these to:
- Connect entities that don’t share native foreign keys.
- Build relationships across multiple data sources.

📘 [Docs → Relationships](https://docs.forestadmin.com/developer-guide-agents-nodejs/agent-customization/relationships)
...
collection.addAction('Validate KYC', {
  ...
  execute: async (ctx, form) => {
    ...
    return { success: form.approved ? 'KYC approved ✅' : 'KYC rejected ❌' };
  },
});
```
...
📘 [Docs → Actions](https://docs.forestadmin.com/developer-guide-agents-nodejs/agent-customization/actions)
...
📘 [Docs → Smart Fields](https://docs.forestadmin.com/developer-guide-agents-nodejs/agent-customization/fields)
...
📘 [Docs → Hooks & Overrides](https://docs.forestadmin.com/developer-guide-agents-nodejs/agent-customization/hooks)
...
📘 [Docs → Segments](https://docs.forestadmin.com/developer-guide-agents-nodejs/agent-customization/segments)
...
📘 [Docs → Charts API](https://docs.forestadmin.com/developer-guide-agents-nodejs/agent-customization/charts)

---

# Plugins

Plugins add cross-cutting behavior (audit, metrics, policies).
...
Typical use cases:
- Global hooks across collections or actions.
- Auditing and compliance.
- Monitoring and metrics.

📘 [Docs → Plugins](https://docs.forestadmin.com/developer-guide-agents-nodejs/agent-customization/plugins)
